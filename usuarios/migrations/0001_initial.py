    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(related_name='usuarios_api', to='auth.group')),
                ('user_permissions', models.ManyToManyField(related_name='usuarios_api', to='auth.permission')),
